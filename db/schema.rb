...
ActiveRecord::Schema.define(:version => 20131026223013) do
  ...
  add_index "main_users", ["reset_password_token"], :name => "index_main_users_on_reset_password_token", :unique => true
